...
# Digest of clickhouse/clickhouse-server:24.8 at campaign start.
_CLICKHOUSE_IMAGE = os.environ.get(
    _CLICKHOUSE_IMAGE_ENV, "clickhouse/clickhouse-server@sha256:1ffa82edee000a42c09313bd9f1293d94c570aee74babc1b3ca9983a35fa597b"
)

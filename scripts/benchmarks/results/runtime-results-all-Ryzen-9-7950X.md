...
| LadybugDB Unindexed (3) | `137375.25 s +- 1943.07` |
...
| LadybugDB Unindexed (3) | `72.66 ms +- 2.55` | `94.82 ms +- 1.35` | `66733741.98 ms +- 628199.78` | `0.00 ms +- 0.00` | `94.98 ms +- 5.52` | `6.53 ms +- 0.19` | `33.82 ms +- 0.48` | `37.46 ms +- 0.39` |
...
| LadybugDB Unindexed (3) | `21.65 ms +- 5.78` | `62.28 ms +- 2.99` | `68369000.00 ms +- 1361888.41` | `0.00 ms +- 0.00` | `91.21 ms +- 1.81` | `746.38 ms +- 4.74` | `813.08 ms +- 3.04` | `840.91 ms +- 6.76` |
...
| LadybugDB Unindexed (3) | `295.61 MiB +- 4.90` | `354.57 MiB +- 4.62` | `17854.71 MiB +- 104.94` | `17854.71 MiB +- 104.94` | `17855.10 MiB +- 104.90` | `17903.11 MiB +- 104.46` |
...
| LadybugDB Unindexed (3) | `12932.83 MiB +- 189.56` | `12914.56 MiB +- 176.25` | `17953.14 MiB +- 61.39` | `17953.14 MiB +- 61.39` | `17953.14 MiB +- 61.39` | `73364.57 MiB +- 1553.06` |
...
| `oltp/ladybug_unindexed` | `6.53 ms +- 0.19` | `33.82 ms +- 0.48` | `37.46 ms +- 0.39` |
| `olap/ladybug_unindexed` | `746.38 ms +- 4.74` | `813.08 ms +- 3.04` | `840.91 ms +- 6.76` |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `oltp_create_cross_type_edge` | `1.72 ms +- 0.04` | `237.72 ms +- 16.59` | `2.70 ms +- 0.23` | `9.58 ms +- 0.50` | `1.95 ms +- 0.03` | `230.77 ms +- 8.92` | `0.29 ms +- 0.02` | `699.71 ms +- 7.45` | `0.18 ms +- 0.01` | `910.85 ms +- 13.17` | `10.95 ms +- 0.10` |
| `oltp_create_type1_node` | `0.93 ms +- 0.02` | `0.81 ms +- 0.03` | `1.49 ms +- 0.08` | `1.65 ms +- 0.14` | `1.06 ms +- 0.07` | `1.06 ms +- 0.04` | `0.23 ms +- 0.02` | `0.22 ms +- 0.01` | `0.03 ms +- 0.00` | `0.02 ms +- 0.01` | `0.42 ms +- 0.02` |
| `oltp_cross_type_lookup` | `1.39 ms +- 0.02` | - | `5.88 ms +- 0.42` | `6.45 ms +- 0.63` | `1.82 ms +- 0.06` | `344.61 ms +- 29.01` | `0.25 ms +- 0.01` | - | `0.06 ms +- 0.01` | `443.23 ms +- 8.10` | `7.41 ms +- 0.60` |
| `oltp_delete_type1_edge` | `0.88 ms +- 0.02` | `757.51 ms +- 0.00` | `5.92 ms +- 0.47` | `6.51 ms +- 0.70` | `1.31 ms +- 0.04` | `1018.11 ms +- 0.00` | `0.22 ms +- 0.02` | `342.35 ms +- 29.00` | `0.07 ms +- 0.01` | `449.94 ms +- 6.10` | `6.25 ms +- 0.22` |
| `oltp_delete_type1_node` | `0.90 ms +- 0.02` | - | `0.91 ms +- 0.03` | `4.18 ms +- 0.39` | `0.86 ms +- 0.02` | - | `0.26 ms +- 0.02` | `371.31 ms +- 24.55` | `0.08 ms +- 0.01` | `447.25 ms +- 9.22` | `6.10 ms +- 0.15` |
| `oltp_merge_cross_type_edge` | `1.98 ms +- 0.07` | `908.46 ms +- 0.00` | `3.33 ms +- 0.28` | `10.53 ms +- 0.74` | `2.35 ms +- 0.05` | `953.25 ms +- 0.00` | `0.31 ms +- 0.02` | `714.68 ms +- 27.81` | `0.18 ms +- 0.00` | `907.58 ms +- 17.77` | `15.90 ms +- 0.64` |
| `oltp_program_create_and_link` | `2.10 ms +- 0.07` | `125.41 ms +- 12.71` | `3.53 ms +- 0.31` | `7.32 ms +- 0.49` | `2.44 ms +- 0.04` | `64.09 ms +- 1.33` | `0.24 ms +- 0.02` | `366.51 ms +- 25.43` | `0.20 ms +- 0.01` | `445.66 ms +- 7.43` | `5.95 ms +- 0.13` |
| `oltp_type1_neighbors` | `1.17 ms +- 0.03` | `717.85 ms +- 0.00` | `5.66 ms +- 0.38` | `6.05 ms +- 0.64` | `1.57 ms +- 0.04` | `347.41 ms +- 24.33` | `0.27 ms +- 0.02` | - | `0.06 ms +- 0.01` | `442.52 ms +- 6.69` | `7.18 ms +- 0.35` |
| `oltp_type1_point_lookup` | `1.14 ms +- 0.02` | `123.13 ms +- 15.42` | `1.39 ms +- 0.02` | `4.97 ms +- 0.78` | `1.37 ms +- 0.03` | `50.55 ms +- 3.30` | `0.27 ms +- 0.02` | `319.79 ms +- 10.29` | `0.06 ms +- 0.01` | `443.21 ms +- 7.59` | `5.85 ms +- 0.04` |
| `oltp_unwind_literal_top2` | `1.00 ms +- 0.02` | `1.00 ms +- 0.04` | `1.27 ms +- 0.05` | `1.35 ms +- 0.05` | `1.22 ms +- 0.03` | `1.23 ms +- 0.05` | `0.22 ms +- 0.02` | `0.22 ms +- 0.01` | `0.01 ms +- 0.00` | `0.01 ms +- 0.00` | `0.57 ms +- 0.03` |
| `oltp_update_cross_type_edge_rank` | `1.20 ms +- 0.03` | `784.90 ms +- 49.47` | `6.66 ms +- 0.34` | `6.19 ms +- 0.40` | `1.50 ms +- 0.02` | `947.03 ms +- 44.54` | `0.23 ms +- 0.03` | `355.98 ms +- 16.20` | `0.05 ms +- 0.00` | `447.20 ms +- 8.91` | `6.26 ms +- 0.16` |
| `oltp_update_type1_score` | `0.84 ms +- 0.02` | `122.13 ms +- 10.95` | `1.70 ms +- 0.09` | `4.81 ms +- 0.63` | `1.08 ms +- 0.03` | `113.56 ms +- 2.79` | `0.23 ms +- 0.03` | `355.32 ms +- 15.00` | `0.08 ms +- 0.02` | `446.62 ms +- 6.86` | `5.58 ms +- 0.14` |

##### OLTP query breakdown, end-to-end `p95`

| Query | SQLite Indexed (3) | SQLite Unindexed (3) | DuckDB Indexed (3) | DuckDB Unindexed (3) | PostgreSQL Indexed (3) | PostgreSQL Unindexed (3) | Neo4j Indexed (3) | Neo4j Unindexed (3) | ArcadeDB Indexed (3) | ArcadeDB Unindexed (3) | LadybugDB Unindexed (3) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `oltp_create_cross_type_edge` | `1.94 ms +- 0.22` | `255.51 ms +- 18.25` | `3.39 ms +- 0.62` | `12.05 ms +- 0.36` | `2.73 ms +- 0.15` | `285.81 ms +- 32.73` | `0.44 ms +- 0.07` | `743.44 ms +- 34.20` | `0.32 ms +- 0.17` | `926.14 ms +- 15.95` | `41.97 ms +- 0.45` |
| `oltp_create_type1_node` | `1.10 ms +- 0.14` | `0.95 ms +- 0.14` | `1.86 ms +- 0.26` | `2.13 ms +- 0.31` | `1.53 ms +- 0.28` | `1.63 ms +- 0.03` | `0.35 ms +- 0.07` | `0.36 ms +- 0.05` | `0.08 ms +- 0.01` | `0.05 ms +- 0.02` | `0.61 ms +- 0.01` |
| `oltp_cross_type_lookup` | `1.66 ms +- 0.24` | - | `7.55 ms +- 0.53` | `8.08 ms +- 0.65` | `2.44 ms +- 0.22` | `379.63 ms +- 17.80` | `0.37 ms +- 0.06` | - | `0.07 ms +- 0.01` | `462.43 ms +- 27.25` | `49.73 ms +- 0.47` |
| `oltp_delete_type1_edge` | `1.03 ms +- 0.19` | `805.68 ms +- 0.00` | `7.54 ms +- 0.45` | `8.20 ms +- 0.87` | `1.95 ms +- 0.18` | `1137.52 ms +- 0.00` | `0.33 ms +- 0.06` | `362.03 ms +- 42.72` | `0.11 ms +- 0.02` | `469.23 ms +- 23.93` | `49.11 ms +- 1.50` |
| `oltp_delete_type1_node` | `1.07 ms +- 0.19` | - | `1.13 ms +- 0.24` | `5.73 ms +- 0.32` | `1.26 ms +- 0.12` | - | `0.39 ms +- 0.07` | `388.96 ms +- 35.11` | `0.11 ms +- 0.01` | `473.07 ms +- 37.40` | `26.54 ms +- 2.72` |
| `oltp_merge_cross_type_edge` | `2.35 ms +- 0.33` | `964.49 ms +- 0.00` | `4.00 ms +- 0.69` | `13.21 ms +- 0.68` | `3.17 ms +- 0.26` | `994.98 ms +- 0.00` | `0.45 ms +- 0.09` | `765.38 ms +- 23.26` | `0.21 ms +- 0.01` | `921.35 ms +- 17.01` | `45.50 ms +- 0.99` |
| `oltp_program_create_and_link` | `2.41 ms +- 0.30` | `134.91 ms +- 14.63` | `4.21 ms +- 0.59` | `8.99 ms +- 0.68` | `3.26 ms +- 0.24` | `74.16 ms +- 4.35` | `0.35 ms +- 0.08` | `382.55 ms +- 29.51` | `0.21 ms +- 0.02` | `456.51 ms +- 10.09` | `26.51 ms +- 0.16` |
| `oltp_type1_neighbors` | `1.43 ms +- 0.24` | `749.89 ms +- 0.00` | `7.33 ms +- 0.42` | `7.71 ms +- 0.76` | `2.06 ms +- 0.23` | `382.13 ms +- 13.56` | `0.40 ms +- 0.07` | - | `0.09 ms +- 0.01` | `452.68 ms +- 10.15` | `49.94 ms +- 0.23` |
| `oltp_type1_point_lookup` | `1.35 ms +- 0.20` | `130.44 ms +- 16.29` | `1.56 ms +- 0.16` | `6.38 ms +- 0.78` | `1.80 ms +- 0.06` | `55.34 ms +- 3.57` | `0.46 ms +- 0.07` | `336.77 ms +- 13.52` | `0.12 ms +- 0.01` | `469.33 ms +- 37.16` | `35.97 ms +- 0.73` |
| `oltp_unwind_literal_top2` | `1.13 ms +- 0.12` | `1.13 ms +- 0.15` | `1.44 ms +- 0.24` | `1.70 ms +- 0.21` | `1.66 ms +- 0.12` | `1.68 ms +- 0.22` | `0.33 ms +- 0.07` | `0.30 ms +- 0.02` | `0.02 ms +- 0.00` | `0.02 ms +- 0.00` | `0.78 ms +- 0.06` |
| `oltp_update_cross_type_edge_rank` | `1.43 ms +- 0.25` | `824.71 ms +- 70.27` | `8.26 ms +- 0.50` | `7.80 ms +- 0.40` | `2.15 ms +- 0.08` | `986.40 ms +- 46.04` | `0.34 ms +- 0.07` | `373.03 ms +- 19.76` | `0.06 ms +- 0.01` | `455.44 ms +- 9.36` | `48.67 ms +- 1.12` |
| `oltp_update_type1_score` | `0.95 ms +- 0.08` | `137.59 ms +- 14.85` | `2.19 ms +- 0.23` | `6.28 ms +- 0.52` | `1.55 ms +- 0.14` | `135.05 ms +- 19.16` | `0.36 ms +- 0.07` | `377.69 ms +- 19.30` | `0.14 ms +- 0.05` | `454.17 ms +- 8.13` | `30.50 ms +- 0.56` |

##### OLTP query breakdown, end-to-end `p99`

| Query | SQLite Indexed (3) | SQLite Unindexed (3) | DuckDB Indexed (3) | DuckDB Unindexed (3) | PostgreSQL Indexed (3) | PostgreSQL Unindexed (3) | Neo4j Indexed (3) | Neo4j Unindexed (3) | ArcadeDB Indexed (3) | ArcadeDB Unindexed (3) | LadybugDB Unindexed (3) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `oltp_create_cross_type_edge` | `2.39 ms +- 0.24` | `272.56 ms +- 29.47` | `4.14 ms +- 1.02` | `13.00 ms +- 0.71` | `3.35 ms +- 0.43` | `312.88 ms +- 53.07` | `0.64 ms +- 0.17` | `811.81 ms +- 71.52` | `0.37 ms +- 0.17` | `935.56 ms +- 19.39` | `44.76 ms +- 0.36` |
| `oltp_create_type1_node` | `1.38 ms +- 0.13` | `1.18 ms +- 0.30` | `2.23 ms +- 0.46` | `2.72 ms +- 0.31` | `1.91 ms +- 0.35` | `2.07 ms +- 0.17` | `0.52 ms +- 0.16` | `0.54 ms +- 0.12` | `0.09 ms +- 0.01` | `0.07 ms +- 0.03` | `0.68 ms +- 0.02` |
| `oltp_cross_type_lookup` | `1.95 ms +- 0.41` | - | `8.41 ms +- 0.94` | `9.01 ms +- 0.91` | `2.93 ms +- 0.31` | `400.81 ms +- 6.85` | `0.51 ms +- 0.12` | - | `0.10 ms +- 0.03` | `507.78 ms +- 93.87` | `53.54 ms +- 0.11` |
| `oltp_delete_type1_edge` | `1.22 ms +- 0.29` | `831.51 ms +- 0.00` | `8.35 ms +- 0.69` | `9.04 ms +- 1.29` | `2.56 ms +- 0.38` | `1236.03 ms +- 0.00` | `0.49 ms +- 0.13` | `428.52 ms +- 130.34` | `0.14 ms +- 0.02` | `488.18 ms +- 46.33` | `53.92 ms +- 1.30` |
| `oltp_delete_type1_node` | `1.35 ms +- 0.32` | - | `1.43 ms +- 0.31` | `6.11 ms +- 0.53` | `1.70 ms +- 0.21` | - | `0.55 ms +- 0.15` | `405.32 ms +- 38.56` | `0.13 ms +- 0.00` | `484.81 ms +- 45.88` | `31.86 ms +- 1.51` |
| `oltp_merge_cross_type_edge` | `2.74 ms +- 0.40` | `1014.09 ms +- 0.00` | `4.68 ms +- 0.98` | `14.45 ms +- 0.90` | `3.81 ms +- 0.41` | `1035.29 ms +- 0.00` | `0.71 ms +- 0.24` | `817.79 ms +- 38.11` | `0.24 ms +- 0.02` | `928.40 ms +- 15.68` | `48.74 ms +- 1.00` |
| `oltp_program_create_and_link` | `2.82 ms +- 0.43` | `141.00 ms +- 16.52` | `4.85 ms +- 0.71` | `10.05 ms +- 1.08` | `3.89 ms +- 0.44` | `86.05 ms +- 2.71` | `0.49 ms +- 0.16` | `395.98 ms +- 31.98` | `0.24 ms +- 0.03` | `473.66 ms +- 24.85` | `31.65 ms +- 0.51` |
| `oltp_type1_neighbors` | `1.72 ms +- 0.39` | `768.88 ms +- 0.00` | `8.02 ms +- 0.53` | `8.55 ms +- 1.06` | `2.50 ms +- 0.30` | `403.83 ms +- 4.23` | `0.58 ms +- 0.14` | - | `0.13 ms +- 0.01` | `462.48 ms +- 13.09` | `54.07 ms +- 0.36` |
| `oltp_type1_point_lookup` | `1.63 ms +- 0.33` | `135.44 ms +- 17.20` | `1.91 ms +- 0.37` | `7.05 ms +- 0.91` | `2.14 ms +- 0.09` | `61.99 ms +- 3.09` | `0.88 ms +- 0.42` | `350.68 ms +- 11.66` | `0.15 ms +- 0.01` | `483.66 ms +- 46.41` | `40.60 ms +- 0.39` |
| `oltp_unwind_literal_top2` | `1.36 ms +- 0.29` | `1.32 ms +- 0.21` | `1.78 ms +- 0.40` | `2.17 ms +- 0.26` | `2.00 ms +- 0.19` | `2.06 ms +- 0.17` | `0.48 ms +- 0.14` | `0.41 ms +- 0.06` | `0.03 ms +- 0.00` | `0.03 ms +- 0.00` | `0.92 ms +- 0.12` |
| `oltp_update_cross_type_edge_rank` | `1.72 ms +- 0.43` | `877.27 ms +- 138.15` | `9.29 ms +- 1.00` | `8.70 ms +- 0.39` | `2.70 ms +- 0.12` | `1031.49 ms +- 56.42` | `0.49 ms +- 0.15` | `387.61 ms +- 23.11` | `0.07 ms +- 0.01` | `461.10 ms +- 7.41` | `52.81 ms +- 1.28` |
| `oltp_update_type1_score` | `1.16 ms +- 0.19` | `157.36 ms +- 37.47` | `2.69 ms +- 0.31` | `6.99 ms +- 0.75` | `1.94 ms +- 0.21` | `148.79 ms +- 29.04` | `0.52 ms +- 0.13` | `398.18 ms +- 9.77` | `0.17 ms +- 0.07` | `462.83 ms +- 10.24` | `36.01 ms +- 0.19` |

##### OLAP query breakdown, end-to-end `p50`

| Query | SQLite Indexed (3) | SQLite Unindexed (3) | DuckDB Indexed (3) | DuckDB Unindexed (3) | PostgreSQL Indexed (3) | PostgreSQL Unindexed (3) | Neo4j Indexed (3) | Neo4j Unindexed (3) | ArcadeDB Indexed (3) | ArcadeDB Unindexed (3) | LadybugDB Unindexed (3) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `olap_cross_type_edge_rollup` | `14334.80 ms +- 938.99` | `2413.09 ms +- 53.82` | `48.21 ms +- 3.37` | `49.04 ms +- 2.29` | `3023.05 ms +- 1706.98` | `2583.15 ms +- 152.11` | `10483.79 ms +- 769.30` | `10640.09 ms +- 721.49` | `9531.07 ms +- 391.64` | `9682.50 ms +- 300.68` | `113.13 ms +- 1.21` |
| `olap_fixed_length_path_projection` | `1.89 ms +- 0.08` | `14530.51 ms +- 605.28` | `1417.11 ms +- 55.85` | `1446.14 ms +- 42.14` | `221.54 ms +- 13.46` | `12837.97 ms +- 5073.98` | `15969.32 ms +- 605.74` | `15467.77 ms +- 330.01` | - | - | `5331.99 ms +- 29.71` |
| `olap_fixed_length_path_with_rebinding` | `20202.04 ms +- 654.37` | `15847.30 ms +- 394.77` | `813.09 ms +- 29.67` | `836.34 ms +- 13.35` | `4757.14 ms +- 725.35` | `7394.72 ms +- 1807.54` | `45516.75 ms +- 1300.42` | `43424.43 ms +- 894.65` | - | - | `4556.04 ms +- 53.68` |
| `olap_graph_introspection_rollup` | `1.86 ms +- 0.08` | `1335.42 ms +- 28.78` | `21.94 ms +- 1.69` | `21.23 ms +- 1.91` | `42.67 ms +- 3.95` | `2676.83 ms +- 1186.90` | `8300.53 ms +- 258.32` | `7834.34 ms +- 328.59` | `14511.29 ms +- 285.70` | `14441.44 ms +- 66.92` | `404.22 ms +- 0.39` |
| `olap_optional_type1_aggregate` | `158.27 ms +- 1.70` | `261.70 ms +- 10.60` | `7.80 ms +- 0.70` | `8.31 ms +- 0.53` | `193.71 ms +- 7.44` | `186.16 ms +- 10.42` | `1304.47 ms +- 86.19` | `1317.72 ms +- 64.13` | - | - | `7.90 ms +- 0.12` |
| `olap_relationship_function_projection` | `6466.58 ms +- 343.54` | `1951.10 ms +- 52.92` | `100.23 ms +- 3.90` | `101.91 ms +- 2.52` | `5669.61 ms +- 1639.42` | `5321.90 ms +- 723.60` | `8440.24 ms +- 565.78` | `7621.06 ms +- 485.02` | `9797.34 ms +- 181.48` | `10015.44 ms +- 176.43` | `595.75 ms +- 1.91` |
| `olap_three_type_path_count` | `15783.96 ms +- 510.37` | `9988.94 ms +- 411.81` | `246.33 ms +- 8.16` | `257.47 ms +- 8.53` | `7343.18 ms +- 980.16` | `6916.59 ms +- 2329.22` | `5349.66 ms +- 171.86` | `5525.85 ms +- 218.36` | `122.93 ms +- 31.75` | `138.29 ms +- 34.21` | `53.48 ms +- 12.19` |
| `olap_type1_active_leaderboard` | `3.68 ms +- 0.46` | `141.95 ms +- 9.76` | `11.03 ms +- 0.49` | `11.52 ms +- 0.42` | `64.95 ms +- 2.97` | `62.95 ms +- 1.16` | `1235.02 ms +- 72.93` | `1275.40 ms +- 80.32` | `1151.49 ms +- 39.97` | `1035.54 ms +- 46.28` | `7.83 ms +- 0.95` |
| `olap_type1_age_rollup` | `1615.47 ms +- 90.30` | `269.22 ms +- 10.29` | `7.05 ms +- 0.68` | `7.40 ms +- 0.34` | `80.64 ms +- 5.47` | `78.47 ms +- 3.40` | `1492.97 ms +- 108.47` | `1505.03 ms +- 76.74` | `631.96 ms +- 84.00` | `702.59 ms +- 56.78` | `5.02 ms +- 0.04` |
| `olap_type2_score_distribution` | `77.83 ms +- 2.01` | `276.04 ms +- 9.11` | `8.52 ms +- 0.68` | `8.77 ms +- 0.28` | `50.05 ms +- 2.77` | `80.46 ms +- 2.89` | `1510.93 ms +- 230.56` | `1366.99 ms +- 89.77` | `647.48 ms +- 47.87` | `621.39 ms +- 7.13` | `4.91 ms +- 0.03` |
| `olap_variable_length_grouped_max_rollup` | `2.67 ms +- 0.38` | `8231.43 ms +- 243.78` | `18.53 ms +- 1.34` | `22.06 ms +- 0.93` | `5.78 ms +- 0.30` | `2169.81 ms +- 110.58` | `0.50 ms +- 0.07` | `346.47 ms +- 18.36` | `0.15 ms +- 0.01` | `541.61 ms +- 36.55` | `10.62 ms +- 0.69` |
| `olap_variable_length_grouped_rollup` | - | - | `5842.29 ms +- 208.22` | `5953.15 ms +- 143.43` | `77266.29 ms +- 2426.86` | `80116.14 ms +- 2190.15` | - | - | - | - | - |
| `olap_variable_length_reachability` | `6.32 ms +- 1.61` | `68825.50 ms +- 2865.57` | `486.41 ms +- 39.33` | `518.37 ms +- 43.74` | `4816.13 ms +- 1954.01` | `14382.55 ms +- 950.12` | `1.69 ms +- 0.04` | - | `1.74 ms +- 0.03` | `466.45 ms +- 86.66` | `8.59 ms +- 0.15` |
| `olap_with_scalar_rebinding` | `1590.61 ms +- 99.93` | `331.04 ms +- 6.36` | `10.33 ms +- 0.41` | `10.73 ms +- 0.56` | `121.55 ms +- 7.98` | `109.56 ms +- 2.27` | `1759.12 ms +- 234.93` | `1540.62 ms +- 86.04` | `833.17 ms +- 35.54` | `916.30 ms +- 164.83` | `10.23 ms +- 0.40` |
| `olap_with_size_predicate_projection` | `186.00 ms +- 4.68` | `188.03 ms +- 5.03` | `11.98 ms +- 0.52` | `11.92 ms +- 0.52` | `120.51 ms +- 8.05` | `116.57 ms +- 10.42` | `1094.37 ms +- 110.89` | `966.01 ms +- 32.83` | `1009.91 ms +- 57.84` | `1020.48 ms +- 27.57` | `73.20 ms +- 1.08` |
| `olap_with_where_lower_projection` | `1336.91 ms +- 69.98` | `195.17 ms +- 5.08` | `11.85 ms +- 0.65` | `12.21 ms +- 0.87` | `114.01 ms +- 10.35` | `103.51 ms +- 2.29` | `1070.85 ms +- 115.46` | `948.60 ms +- 39.02` | `872.68 ms +- 47.66` | `874.97 ms +- 19.76` | `12.85 ms +- 0.73` |

##### OLAP query breakdown, end-to-end `p95`

| Query | SQLite Indexed (3) | SQLite Unindexed (3) | DuckDB Indexed (3) | DuckDB Unindexed (3) | PostgreSQL Indexed (3) | PostgreSQL Unindexed (3) | Neo4j Indexed (3) | Neo4j Unindexed (3) | ArcadeDB Indexed (3) | ArcadeDB Unindexed (3) | LadybugDB Unindexed (3) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `olap_cross_type_edge_rollup` | `14638.37 ms +- 729.89` | `2556.93 ms +- 175.58` | `53.60 ms +- 5.19` | `54.08 ms +- 2.08` | `4709.48 ms +- 2613.02` | `3576.36 ms +- 119.71` | `10921.58 ms +- 663.62` | `10891.21 ms +- 884.15` | `9738.48 ms +- 380.43` | `10108.24 ms +- 489.67` | `163.23 ms +- 1.76` |
| `olap_fixed_length_path_projection` | `2.13 ms +- 0.18` | `14850.74 ms +- 704.91` | `1444.76 ms +- 67.39` | `1487.95 ms +- 56.12` | `655.70 ms +- 553.13` | `16476.97 ms +- 6249.69` | `16660.27 ms +- 263.74` | `15905.57 ms +- 570.05` | - | - | `5655.34 ms +- 35.13` |
| `olap_fixed_length_path_with_rebinding` | `20349.62 ms +- 724.59` | `16072.40 ms +- 423.11` | `844.38 ms +- 37.84` | `860.77 ms +- 20.71` | `11096.31 ms +- 11560.25` | `10703.34 ms +- 2876.08` | `49936.07 ms +- 5168.86` | `44291.07 ms +- 1026.95` | - | - | `4849.28 ms +- 19.75` |
| `olap_graph_introspection_rollup` | `1.89 ms +- 0.10` | `1354.78 ms +- 27.51` | `24.82 ms +- 2.95` | `24.60 ms +- 2.93` | `55.56 ms +- 21.72` | `4062.81 ms +- 2152.47` | `8414.02 ms +- 287.15` | `7928.40 ms +- 362.15` | `14717.31 ms +- 365.96` | `14621.39 ms +- 92.17` | `442.24 ms +- 4.66` |
| `olap_optional_type1_aggregate` | `164.36 ms +- 1.42` | `267.61 ms +- 13.46` | `9.67 ms +- 0.76` | `10.40 ms +- 0.71` | `221.43 ms +- 23.52` | `197.03 ms +- 18.13` | `1346.04 ms +- 108.14` | `1342.44 ms +- 71.25` | - | - | `65.67 ms +- 1.73` |
| `olap_relationship_function_projection` | `6541.25 ms +- 386.75` | `1989.36 ms +- 59.98` | `108.10 ms +- 7.80` | `105.95 ms +- 4.04` | `7169.38 ms +- 2258.29` | `7551.87 ms +- 2625.83` | `8724.73 ms +- 703.76` | `7956.95 ms +- 705.88` | `9981.97 ms +- 312.51` | `10419.46 ms +- 407.76` | `618.86 ms +- 11.64` |
| `olap_three_type_path_count` | `15994.56 ms +- 590.26` | `10274.07 ms +- 586.69` | `277.38 ms +- 32.77` | `308.16 ms +- 11.01` | `8784.38 ms +- 2141.59` | `9692.59 ms +- 3510.83` | `5815.87 ms +- 123.91` | `6043.29 ms +- 203.58` | `135.66 ms +- 38.80` | `4387.03 ms +- 4617.94` | `85.92 ms +- 2.42` |
| `olap_type1_active_leaderboard` | `4.44 ms +- 0.93` | `147.85 ms +- 11.37` | `13.34 ms +- 0.74` | `14.13 ms +- 0.97` | `78.65 ms +- 11.07` | `71.37 ms +- 8.08` | `1264.50 ms +- 75.95` | `1306.66 ms +- 89.70` | `2849.15 ms +- 2208.09` | `3739.72 ms +- 1257.16` | `39.33 ms +- 0.76` |
| `olap_type1_age_rollup` | `1660.44 ms +- 79.23` | `276.49 ms +- 12.84` | `8.84 ms +- 0.80` | `8.88 ms +- 0.25` | `180.39 ms +- 152.07` | `87.65 ms +- 10.02` | `1556.64 ms +- 157.85` | `1528.20 ms +- 83.92` | `864.26 ms +- 84.78` | `954.22 ms +- 71.15` | `19.46 ms +- 0.57` |
| `olap_type2_score_distribution` | `80.28 ms +- 3.00` | `287.23 ms +- 19.09` | `9.52 ms +- 1.15` | `10.37 ms +- 0.02` | `53.84 ms +- 4.09` | `89.38 ms +- 9.89` | `1545.51 ms +- 227.30` | `1390.74 ms +- 97.09` | `685.62 ms +- 88.92` | `683.03 ms +- 30.13` | `20.02 ms +- 4.13` |
| `olap_variable_length_grouped_max_rollup` | `2.91 ms +- 0.51` | `8507.29 ms +- 424.53` | `20.62 ms +- 2.15` | `24.59 ms +- 2.08` | `7.02 ms +- 1.04` | `2359.25 ms +- 156.13` | `0.92 ms +- 0.22` | `359.81 ms +- 24.86` | `0.20 ms +- 0.02` | `783.44 ms +- 131.46` | `31.74 ms +- 1.10` |
| `olap_variable_length_grouped_rollup` | - | - | `5943.48 ms +- 254.61` | `6199.21 ms +- 128.53` | `83765.46 ms +- 6595.98` | `86857.11 ms +- 4267.28` | - | - | - | - | - |
| `olap_variable_length_reachability` | `7.06 ms +- 2.23` | `72000.38 ms +- 5126.20` | `520.05 ms +- 39.84` | `554.93 ms +- 55.16` | `6825.51 ms +- 2233.91` | `16869.31 ms +- 2080.08` | `2.53 ms +- 0.42` | - | `1.90 ms +- 0.07` | `540.65 ms +- 186.18` | `27.73 ms +- 1.59` |
| `olap_with_scalar_rebinding` | `1621.20 ms +- 119.04` | `342.53 ms +- 8.17` | `12.68 ms +- 0.28` | `13.82 ms +- 0.47` | `135.42 ms +- 21.89` | `117.47 ms +- 1.43` | `1819.64 ms +- 221.09` | `1578.76 ms +- 87.21` | `867.84 ms +- 24.73` | `1040.86 ms +- 309.55` | `43.82 ms +- 0.28` |
| `olap_with_size_predicate_projection` | `192.90 ms +- 5.83` | `193.21 ms +- 8.37` | `13.69 ms +- 1.52` | `14.31 ms +- 1.31` | `134.49 ms +- 22.92` | `123.91 ms +- 12.44` | `1172.80 ms +- 110.22` | `988.23 ms +- 35.64` | `1070.02 ms +- 54.42` | `1104.82 ms +- 23.55` | `83.51 ms +- 0.84` |
| `olap_with_where_lower_projection` | `1365.83 ms +- 72.81` | `200.37 ms +- 8.36` | `14.41 ms +- 1.87` | `14.87 ms +- 0.63` | `124.62 ms +- 21.41` | `114.85 ms +- 12.59` | `1149.89 ms +- 128.41` | `971.18 ms +- 45.55` | `914.74 ms +- 40.79` | `1034.86 ms +- 191.51` | `50.07 ms +- 0.41` |

##### OLAP query breakdown, end-to-end `p99`

| Query | SQLite Indexed (3) | SQLite Unindexed (3) | DuckDB Indexed (3) | DuckDB Unindexed (3) | PostgreSQL Indexed (3) | PostgreSQL Unindexed (3) | Neo4j Indexed (3) | Neo4j Unindexed (3) | ArcadeDB Indexed (3) | ArcadeDB Unindexed (3) | LadybugDB Unindexed (3) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `olap_cross_type_edge_rollup` | `14728.60 ms +- 721.31` | `2602.90 ms +- 230.35` | `56.10 ms +- 7.41` | `62.79 ms +- 10.32` | `5523.20 ms +- 3730.47` | `3736.60 ms +- 90.34` | `11266.70 ms +- 754.64` | `10969.18 ms +- 877.06` | `10320.61 ms +- 193.00` | `10840.34 ms +- 675.14` | `166.53 ms +- 0.82` |
| `olap_fixed_length_path_projection` | `2.21 ms +- 0.26` | `15078.91 ms +- 862.36` | `1456.18 ms +- 69.83` | `1508.81 ms +- 67.34` | `944.52 ms +- 646.51` | `17761.73 ms +- 8013.22` | `16825.14 ms +- 189.48` | `16430.67 ms +- 893.95` | - | - | `5872.91 ms +- 111.06` |
| `olap_fixed_length_path_with_rebinding` | `20400.74 ms +- 785.26` | `16160.57 ms +- 463.68` | `853.71 ms +- 35.76` | `871.04 ms +- 20.46` | `12256.42 ms +- 13469.30` | `11637.28 ms +- 4019.27` | `51690.85 ms +- 7045.64` | `45109.11 ms +- 1966.18` | - | - | `4959.69 ms +- 44.63` |
| `olap_graph_introspection_rollup` | `1.92 ms +- 0.14` | `1373.23 ms +- 26.30` | `28.75 ms +- 5.98` | `27.14 ms +- 3.25` | `956.92 ms +- 1579.66` | `4407.59 ms +- 2014.75` | `8558.15 ms +- 219.21` | `8009.92 ms +- 419.41` | `14861.02 ms +- 418.74` | `14835.53 ms +- 274.05` | `458.12 ms +- 7.74` |
| `olap_optional_type1_aggregate` | `199.79 ms +- 55.83` | `284.59 ms +- 25.49` | `9.99 ms +- 0.63` | `11.77 ms +- 1.92` | `243.94 ms +- 41.35` | `200.95 ms +- 18.49` | `1547.60 ms +- 416.12` | `1838.10 ms +- 745.86` | - | - | `68.16 ms +- 1.94` |
| `olap_relationship_function_projection` | `6589.09 ms +- 433.20` | `2008.52 ms +- 74.46` | `118.15 ms +- 16.36` | `115.76 ms +- 7.35` | `7610.63 ms +- 2676.90` | `8502.51 ms +- 2873.78` | `8799.31 ms +- 770.95` | `8066.11 ms +- 754.12` | `10001.03 ms +- 333.15` | `10658.62 ms +- 734.65` | `638.92 ms +- 25.54` |
| `olap_three_type_path_count` | `16038.47 ms +- 572.94` | `10329.12 ms +- 612.17` | `283.51 ms +- 32.91` | `313.65 ms +- 11.96` | `9407.91 ms +- 2882.66` | `10843.66 ms +- 4322.00` | `6182.19 ms +- 338.84` | `6239.90 ms +- 128.52` | `143.24 ms +- 43.96` | `6192.88 ms +- 5682.59` | `90.36 ms +- 4.88` |
| `olap_type1_active_leaderboard` | `4.83 ms +- 1.23` | `152.42 ms +- 12.21` | `14.19 ms +- 0.99` | `15.25 ms +- 1.42` | `90.83 ms +- 21.76` | `82.94 ms +- 20.44` | `1381.49 ms +- 214.00` | `1769.45 ms +- 704.92` | `3848.75 ms +- 2638.04` | `6097.21 ms +- 2417.34` | `42.18 ms +- 0.27` |
| `olap_type1_age_rollup` | `1710.03 ms +- 105.47` | `289.76 ms +- 21.69` | `9.20 ms +- 1.31` | `9.40 ms +- 0.42` | `211.86 ms +- 192.74` | `111.44 ms +- 42.46` | `1685.00 ms +- 350.22` | `1538.72 ms +- 85.60` | `941.73 ms +- 73.59` | `1080.66 ms +- 172.50` | `32.39 ms +- 3.01` |
| `olap_type2_score_distribution` | `82.48 ms +- 3.38` | `291.87 ms +- 22.41` | `10.21 ms +- 0.96` | `10.91 ms +- 0.15` | `56.74 ms +- 2.43` | `92.82 ms +- 9.69` | `1625.27 ms +- 227.86` | `1467.22 ms +- 72.80` | `712.90 ms +- 70.58` | `708.62 ms +- 31.23` | `32.76 ms +- 5.23` |
| `olap_variable_length_grouped_max_rollup` | `2.97 ms +- 0.54` | `8656.28 ms +- 568.35` | `22.23 ms +- 2.70` | `26.13 ms +- 2.17` | `10.33 ms +- 5.82` | `2402.62 ms +- 179.48` | `2.67 ms +- 0.28` | `372.17 ms +- 28.77` | `0.28 ms +- 0.08` | `918.31 ms +- 230.64` | `35.48 ms +- 1.12` |
| `olap_variable_length_grouped_rollup` | - | - | `6003.40 ms +- 299.21` | `6325.47 ms +- 208.20` | `84756.93 ms +- 6566.56` | `91866.96 ms +- 2237.40` | - | - | - | - | - |
| `olap_variable_length_reachability` | `9.19 ms +- 4.37` | `72863.20 ms +- 5559.52` | `546.98 ms +- 25.54` | `587.62 ms +- 58.49` | `7509.05 ms +- 2289.25` | `17643.09 ms +- 3023.30` | `4.19 ms +- 1.32` | - | `1.98 ms +- 0.09` | `606.78 ms +- 270.37` | `31.00 ms +- 1.45` |
| `olap_with_scalar_rebinding` | `1650.29 ms +- 158.72` | `349.71 ms +- 11.60` | `13.48 ms +- 0.35` | `14.36 ms +- 0.67` | `146.96 ms +- 38.21` | `124.02 ms +- 3.00` | `2326.93 ms +- 820.98` | `1638.61 ms +- 141.44` | `899.66 ms +- 35.47` | `1082.27 ms +- 324.46` | `45.93 ms +- 0.64` |
| `olap_with_size_predicate_projection` | `197.92 ms +- 9.20` | `199.41 ms +- 12.67` | `14.10 ms +- 1.65` | `14.97 ms +- 1.29` | `140.21 ms +- 27.21` | `126.26 ms +- 13.67` | `1246.15 ms +- 172.93` | `1093.66 ms +- 68.85` | `1084.19 ms +- 67.04` | `1132.51 ms +- 27.80` | `86.58 ms +- 1.86` |
| `olap_with_where_lower_projection` | `1378.79 ms +- 66.43` | `203.64 ms +- 10.85` | `15.49 ms +- 2.08` | `15.50 ms +- 0.74` | `131.46 ms +- 31.60` | `124.70 ms +- 23.38` | `1166.05 ms +- 135.40` | `1085.63 ms +- 64.25` | `933.29 ms +- 51.13` | `1166.55 ms +- 398.34` | `52.65 ms +- 0.59` |
